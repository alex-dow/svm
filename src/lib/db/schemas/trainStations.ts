...
export type TrainStationPlatformItem =
  Selectable<TrainStationPlatformItemTable>;
export type CreateTrainStationPlatformItem =
  Insertable<TrainStationPlatformItemTable>;
export type UpdateTrainStationPlatformItem =
  Updateable<TrainStationPlatformItemTable>;
